<template>
    ...
    >
        <div
            ...
            :class="{
                'bg-green-50': toastState.type === 'success',
                'bg-red-50': toastState.type === 'error',
                'bg-blue-50': toastState.type === 'info',
                'bg-yellow-50': toastState.type === 'warning'
            }"
        >
            <div class="p-4">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                        <svg
                            class="h-6 w-6"
                            :class="{
                                'text-green-400': toastState.type === 'success',
                                'text-red-400': toastState.type === 'error',
                                'text-blue-400': toastState.type === 'info',
                                'text-yellow-400': toastState.type === 'warning'
                            }"
                        ...
                        >
                            ...
                            />
                            <path
                                v-else-if="toastState.type === 'info'"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                stroke-width="2"
                            ...
                            />
                            <path
                                v-else-if="toastState.type === 'warning'"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                stroke-width="2"
                    ...
                    <div class="ml-3 w-0 flex-1 pt-0.5">
                        <p
                            ...
                            :class="{
                                'text-green-800': toastState.type === 'success',
                                'text-red-800': toastState.type === 'error',
                                'text-blue-800': toastState.type === 'info',
                                'text-yellow-800': toastState.type === 'warning'
                            }"
                        >
                            {{ toastState.message }}
                        </p>
